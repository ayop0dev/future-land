  ...
  $projects = [
    ...
    'ar' => [
      'agricultural' => [
        ...
        'about' => 'تطوّر فيوتشر لاند حالياً موقعين زراعيين. الأول في وادي النطرون، تربته رملية، ونسبة الاستصلاح فيه 80%، ويُروى من آبار متاحة، ويبعد كيلومترين عن طريق وادي النطرون العلمين. الثاني على طريق الضبعة (قبل المهرة)، تربته طينية، ونسبة الاستصلاح فيه 100%، ويعتمد على الري السطحي مع توافر المياه، ويقع قريباً من الطرق الرئيسية. الموقعان مزوّدان بكامل المرافق، بما فيها مياه الشرب والكهرباء، وبمستندات قانونية كاملة.',
      ...
      'fuel' => [
        ...
        'summary' => 'ثماني وحدات تجارية على طريق رئيسي بمدينة السادات، متاحة للإيجار داخل محطة وقود، بمرافق متكاملة وتشغيل على مدار 24 ساعة.',
        'locationLink' => 'https://maps.app.goo.gl/NR13FQJ5zmwBfthY6',
        'hero' => 'assets/images/fuel-hero.png',
        'opportunityTitle' => 'موقع تجاري قائم على حركة مستمرة وتشغيل على مدار الساعة.',
        'aboutHeading' => 'عن المشروع',
        'about' => 'بنزينة وطنية هي محطة وقود وطنية تقع على طريق رئيسي بمدينة السادات. المشروع حالياً في مرحلة التشطيب ويضم ثماني وحدات تجارية بمساحات متنوعة، متاحة للإيجار فقط. جميع الأنشطة مسموح بها، والمداخل والمخارج ومواقف السيارات متاحة، والمحطة تعمل على مدار 24 ساعة.',
