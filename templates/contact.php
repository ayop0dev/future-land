  ...
  <div class="page-shell contact-layout">
    ...
    <div data-reveal>
      <form class="form-grid" data-enquiry-form>
        ...
        <fieldset class="field m-0 border-0 p-0"><legend class="mb-3 text-[.92rem]"><?= e($forms['method']) ?></legend><div class="flex flex-wrap gap-5"><?php foreach ($forms['methods'] as $method): ?><label class="flex items-center gap-2 cursor-pointer"><input class="contact-method-input cursor-pointer" type="radio" name="contact_method" value="<?= e($method) ?>" required> <?= e($method) ?></label><?php endforeach; ?></div></fieldset>
